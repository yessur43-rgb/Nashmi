...
export const analyzeImageForJournal = async (base64Image: string, mimeType: string, location: { lat: number; lon: number } | null): Promise<JournalImageAnalysis | null> => {
    ...
    3.  **إذا كانت صورة عادية:**
        ...
        - اكتب وصفاً قصيراً وجذاباً ومثيراً للفضول يربط روح الصورة بالمكان. ركز على المشاعر أو الأجواء أو التفاصيل الخفية التي تجعل اللحظة مميزة. **يجب أن يكون الوصف باللغة العربية حصراً.**
